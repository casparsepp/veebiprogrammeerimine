	...
	if(isset($_POST["submit"])) {
		...
		if(!empty($_FILES["fileToUpload"]["name"])){
			...
			//Kui saab üles laadida
				...
				//sõltuvalt failitüübist, loob pildiobjekti
				...
				//mis pildile, suurus, nurk vastupäeva, x, y, värv, font
				imagettftext ($myImage, 20, -45, 10, 25, $textColor, "../../graphics/ARIALBD.TTF", $textToImage);
